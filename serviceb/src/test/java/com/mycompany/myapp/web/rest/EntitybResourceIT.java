...
public class EntitybResourceIT {
    ...
    public void checkNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = entitybRepository.findAll().size();
        // set the field null
        entityb.setName(null);

        // Create the Entityb, which fails.
        ...
        List<Entityb> entitybList = entitybRepository.findAll();
        assertThat(entitybList).hasSize(databaseSizeBeforeTest);
    }
