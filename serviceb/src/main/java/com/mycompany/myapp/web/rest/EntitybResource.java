...
public class EntitybResource {
    ...
    public ResponseEntity<Entityb> createEntityb(@Valid @RequestBody Entityb entityb) throws URISyntaxException {
     ...
     */
    @PutMapping("/entitybs")
    public ResponseEntity<Entityb> updateEntityb(@Valid @RequestBody Entityb entityb) throws URISyntaxException {
     ...
     */
    @GetMapping("/entitybs")
    public ResponseEntity<List<Entityb>> getAllEntitybs(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of Entitybs");
        Page<Entityb> page = entitybRepository.findAll(pageable);
