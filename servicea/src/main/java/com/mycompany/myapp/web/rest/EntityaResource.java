...
public class EntityaResource {
    ...
    public ResponseEntity<Entitya> createEntitya(@Valid @RequestBody Entitya entitya) throws URISyntaxException {
     ...
     */
    @PutMapping("/entityas")
    public ResponseEntity<Entitya> updateEntitya(@Valid @RequestBody Entitya entitya) throws URISyntaxException {
     ...
     */
    @GetMapping("/entityas")
    public ResponseEntity<List<Entitya>> getAllEntityas(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of Entityas");
        Page<Entitya> page = entityaRepository.findAll(pageable);
