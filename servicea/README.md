...
To build the final jar and optimize the servicea application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v6.0.1/microservices-architecture/#consul
